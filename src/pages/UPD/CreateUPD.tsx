                  ...
                  <table className="w-full">
                    <thead className="bg-slate-50 border-b border-slate-200">
                      <tr>
                        <th className="px-4 py-3 text-left text-xs font-medium text-slate-600 uppercase tracking-wider">
                          <input
                            type="checkbox"
                            checked={selectedItemIds.size === availableItems.length}
                      ...
                      {availableItems.map((item) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-sm text-slate-900">
                            <div>{item.reception_number}</div>
                            <div className="text-xs text-slate-500">
                              {new Date(item.reception_date).toLocaleDateString('ru-RU')}
                            </div>
                          </td>
                          <td className="px-4 py-3 text-sm text-slate-900">
                            <div className="font-medium">{item.motor_inventory_number}</div>
                            <div className="text-xs text-slate-500">
                              {item.motor_service_description}
                            </div>
                          </td>
                          <td className="px-4 py-3 text-sm text-slate-900">
                    ...
                    {selectedItemIds.size > 0 && (
                      <tfoot className="bg-slate-50 border-t-2 border-slate-300">
                        <tr>
                          <td colSpan={9} className="px-4 py-3 text-sm font-semibold text-slate-900 text-right">
